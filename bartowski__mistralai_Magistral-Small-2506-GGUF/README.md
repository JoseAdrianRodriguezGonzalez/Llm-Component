...
| [Magistral-Small-2506-Q2_K.gguf](https://huggingface.co/bartowski/mistralai_Magistral-Small-2506-GGUF/blob/main/mistralai_Magistral-Small-2506-Q2_K.gguf) | Q2_K | 8.89GB | false | Very low quality but surprisingly usable. |
...
```
huggingface-cli download bartowski/mistralai_Magistral-Small-2506-GGUF --include "mistralai_Magistral-Small-2506-Q4_K_M.gguf" --local-dir ./
```

If the model is bigger than 50GB, it will have been split into multiple files. In order to download them all to a local folder, run:

```
huggingface-cli download bartowski/mistralai_Magistral-Small-2506-GGUF --include "mistralai_Magistral-Small-2506-Q8_0/*" --local-dir ./
```

You can either specify a new local-dir (mistralai_Magistral-Small-2506-Q8_0) or download them all in place (./)
