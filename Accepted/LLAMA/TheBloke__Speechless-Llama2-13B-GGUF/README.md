...
Under Download Model, you can enter the model repo: TheBloke/Speechless-Llama2-13B-GGUF and below it, a specific filename to download, such as: speechless-llama2-13b.q4_K_M.gguf.
...
```shell
huggingface-cli download TheBloke/Speechless-Llama2-13B-GGUF speechless-llama2-13b.q4_K_M.gguf --local-dir . --local-dir-use-symlinks False
```
...
```shell
huggingface-cli download TheBloke/Speechless-Llama2-13B-GGUF --local-dir . --local-dir-use-symlinks False --include='*Q4_K*gguf'
```
...
```shell
HUGGINGFACE_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download TheBloke/Speechless-Llama2-13B-GGUF speechless-llama2-13b.q4_K_M.gguf --local-dir . --local-dir-use-symlinks False
```
...
```shell
./main -ngl 32 -m speechless-llama2-13b.q4_K_M.gguf --color -c 4096 --temp 0.7 --repeat_penalty 1.1 -n -1 -p "Below is an instruction that describes a task. Write a response that appropriately completes the request.\n\n### Instruction:\n{prompt}\n\n### Response:"
```
...
llm = AutoModelForCausalLM.from_pretrained("TheBloke/Speechless-Llama2-13B-GGUF", model_file="speechless-llama2-13b.q4_K_M.gguf", model_type="llama", gpu_layers=50)
