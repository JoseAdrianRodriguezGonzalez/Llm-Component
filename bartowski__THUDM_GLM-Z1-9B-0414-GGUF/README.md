...
| [GLM-Z1-9B-0414-Q3_K_XL.gguf](https://huggingface.co/bartowski/THUDM_GLM-Z1-9B-0414-GGUF/blob/main/THUDM_GLM-Z1-9B-0414-Q3_K_XL.gguf) | Q3_K_XL | 5.74GB | false | Uses Q8_0 for embed and output weights. Lower quality but usable, good for low RAM availability. |
...
```
huggingface-cli download bartowski/THUDM_GLM-Z1-9B-0414-GGUF --include "THUDM_GLM-Z1-9B-0414-Q4_K_M.gguf" --local-dir ./
```

If the model is bigger than 50GB, it will have been split into multiple files. In order to download them all to a local folder, run:

```
huggingface-cli download bartowski/THUDM_GLM-Z1-9B-0414-GGUF --include "THUDM_GLM-Z1-9B-0414-Q8_0/*" --local-dir ./
```

You can either specify a new local-dir (THUDM_GLM-Z1-9B-0414-Q8_0) or download them all in place (./)
