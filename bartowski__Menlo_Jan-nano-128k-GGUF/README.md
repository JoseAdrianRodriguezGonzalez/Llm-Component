...
| [Jan-nano-128k-IQ4_NL.gguf](https://huggingface.co/bartowski/Menlo_Jan-nano-128k-GGUF/blob/main/Menlo_Jan-nano-128k-IQ4_NL.gguf) | IQ4_NL | 2.38GB | false | Similar to IQ4_XS, but slightly larger. Offers online repacking for ARM CPU inference. |
...
```
huggingface-cli download bartowski/Menlo_Jan-nano-128k-GGUF --include "Menlo_Jan-nano-128k-Q4_K_M.gguf" --local-dir ./
```

If the model is bigger than 50GB, it will have been split into multiple files. In order to download them all to a local folder, run:

```
huggingface-cli download bartowski/Menlo_Jan-nano-128k-GGUF --include "Menlo_Jan-nano-128k-Q8_0/*" --local-dir ./
```

You can either specify a new local-dir (Menlo_Jan-nano-128k-Q8_0) or download them all in place (./)
