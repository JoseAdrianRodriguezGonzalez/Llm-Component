...
```shell
huggingface-cli download TheBloke/Luban-13B-GGUF --local-dir . --local-dir-use-symlinks False --include='*Q4_K*gguf'
```
...
```shell
HUGGINGFACE_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download TheBloke/Luban-13B-GGUF luban-13b.q4_K_M.gguf --local-dir . --local-dir-use-symlinks False
```
