...
```shell
huggingface-cli download TheBloke/Llama-2-70B-Orca-200k-GGUF --local-dir . --local-dir-use-symlinks False --include='*Q4_K*gguf'
```
...
```shell
HUGGINGFACE_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download TheBloke/Llama-2-70B-Orca-200k-GGUF llama-2-70b-orca-200k.q4_K_M.gguf --local-dir . --local-dir-use-symlinks False
```
