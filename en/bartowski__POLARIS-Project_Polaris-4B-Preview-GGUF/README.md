...
| [Polaris-4B-Preview-IQ4_NL.gguf](https://huggingface.co/bartowski/POLARIS-Project_Polaris-4B-Preview-GGUF/blob/main/POLARIS-Project_Polaris-4B-Preview-IQ4_NL.gguf) | IQ4_NL | 2.38GB | false | Similar to IQ4_XS, but slightly larger. Offers online repacking for ARM CPU inference. |
...
```
huggingface-cli download bartowski/POLARIS-Project_Polaris-4B-Preview-GGUF --include "POLARIS-Project_Polaris-4B-Preview-Q4_K_M.gguf" --local-dir ./
```

If the model is bigger than 50GB, it will have been split into multiple files. In order to download them all to a local folder, run:

```
huggingface-cli download bartowski/POLARIS-Project_Polaris-4B-Preview-GGUF --include "POLARIS-Project_Polaris-4B-Preview-Q8_0/*" --local-dir ./
```

You can either specify a new local-dir (POLARIS-Project_Polaris-4B-Preview-Q8_0) or download them all in place (./)
